...
const descriptivePromptTemplates = {
    [generationMode.CHARACTER]: 'Write an extremely detailed, ultra-descriptive paragraph of {{char}}\'s complete visual appearance as if commissioning a full body portrait. Be as specific and granular as possible — describe exact colors, textures, and materials. Include species or race, gender, age, build, skin tone and texture, hair color and style, eye color and shape, facial features, expression, clothing with fabric details, accessories, posture, and distinguishing marks. Describe composition, framing, and lighting. Leave nothing to imagination — every visual element should be explicitly described. Write in flowing natural language, not as a list of keywords. Do not use quotation marks or markdown formatting.',
    [generationMode.FACE]: 'Write an extremely detailed, ultra-descriptive paragraph of {{char}}\'s face and upper body as if commissioning a close-up portrait. Be as specific and granular as possible — describe exact colors, textures, and subtle details. Focus on facial structure, bone structure, skin tone and texture, pores and complexion, eye color and shape, iris detail, eyelashes, eyebrows, expression and micro-expressions, lip shape and color, and hair as it frames the face including individual strands and highlights. Include portrait lighting direction, quality, and mood. Leave nothing to imagination — every visual element should be explicitly described. Write in flowing natural language, not as a list of keywords. Do not use quotation marks or markdown formatting.',
    [generationMode.USER]: 'Write an extremely detailed, ultra-descriptive paragraph of {{user}}\'s complete visual appearance from {{char}}\'s perspective, as if commissioning a full body portrait. Be as specific and granular as possible — describe exact colors, textures, and materials. Include species or race, gender, age, build, skin tone and texture, hair color and style, eye color and shape, facial features, expression, clothing with fabric details, accessories, posture, and distinguishing marks. Describe composition, framing, and lighting. Leave nothing to imagination — every visual element should be explicitly described. Write in flowing natural language, not as a list of keywords. Do not use quotation marks or markdown formatting.',
    [generationMode.SCENARIO]: 'Write an extremely detailed, ultra-descriptive paragraph of the current scene as a rich visual illustration. Be as specific and granular as possible — describe exact colors, textures, materials, and spatial relationships. Include what is happening, each character\'s full physical appearance with specific details, the surroundings with architectural or natural features, atmosphere, lighting direction and quality, color palette, shadows, reflections, and ambient effects. Leave nothing to imagination — every visual element should be explicitly described. Write in flowing natural language, not as a list of keywords. Do not use quotation marks or markdown formatting.',
    [generationMode.NOW]: 'Translate the last chat message into an extremely detailed, ultra-descriptive paragraph of the visual scene. Be as specific and granular as possible — describe exact colors, textures, materials, and spatial relationships. Reference characters by their full physical description rather than names. Include the setting with specific environmental details, poses, body language, spatial relationships between elements, action, expressions, lighting, atmosphere, and color palette. Leave nothing to imagination — every visual element should be explicitly described. Write in flowing natural language, not as a list of keywords. Do not use quotation marks or markdown formatting.',
    [generationMode.RAW_LAST]: promptTemplates[generationMode.RAW_LAST],
    [generationMode.BACKGROUND]: 'Write an extremely detailed, ultra-descriptive paragraph of an atmospheric environment illustration of {{char}}\'s surroundings. Be as specific and granular as possible — describe exact colors, textures, materials, and spatial depth. Include the location, architectural or natural features with specific structural details, time of day, weather conditions, lighting direction and quality, color palette, shadows, reflections, ambient details, atmospheric effects like haze or particles, and foreground/background layering. Do not include any characters. Leave nothing to imagination — every visual element should be explicitly described. Write in flowing natural language, not as a list of keywords. Do not use quotation marks or markdown formatting.',
};
